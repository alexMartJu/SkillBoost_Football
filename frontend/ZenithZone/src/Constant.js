export default {
  ...
  //Pistas Dashboard Entrenador
  FETCH_PISTAS: "FETCH_PISTAS",
  SET_PISTAS: "SET_PISTAS",
  SET_SELECTED_PISTA: "SET_SELECTED_PISTA",
  
  //Horarios Dashboard Entrenador
  FETCH_HORARIOS_OCUPADOS: "FETCH_HORARIOS_OCUPADOS",
  SET_HORARIOS_OCUPADOS: "SET_HORARIOS_OCUPADOS",
  
  //Estados Dashboard Entrenador
  SET_LOADING: "SET_LOADING",
  SET_ERROR: "SET_ERROR",

  SET_TECNIFICACIONES: "SET_TECNIFICACIONES",
  SET_SUBTIPOS_TECNIFICACION: "SET_SUBTIPOS_TECNIFICACION",
  FETCH_SUBTIPOS_TECNIFICACION: "FETCH_SUBTIPOS_TECNIFICACION",
  FETCH_TECNIFICACIONES: "FETCH_TECNIFICACIONES",

  //Entrenamientos pendientes (Admin)
  FETCH_PENDING_ENTRENAMIENTOS: "FETCH_PENDING_ENTRENAMIENTOS",
  SET_PENDING_ENTRENAMIENTOS: "SET_PENDING_ENTRENAMIENTOS",
  APPROVE_ENTRENAMIENTO: "APPROVE_ENTRENAMIENTO",
  DENY_ENTRENAMIENTO: "DENY_ENTRENAMIENTO",
  SET_LOADING_ENTRENAMIENTOS: "SET_LOADING_ENTRENAMIENTOS",
  SET_ERROR_ENTRENAMIENTOS: "SET_ERROR_ENTRENAMIENTOS",

  SET_PENDING_ENTRENAMIENTOS: "SET_PENDING_ENTRENAMIENTOS",
  SET_APPROVED_ENTRENAMIENTOS: "SET_APPROVED_ENTRENAMIENTOS",
  SET_DENIED_ENTRENAMIENTOS: "SET_DENIED_ENTRENAMIENTOS",

  SET_INSCRIPCIONES: "SET_INSCRIPCIONES",
  SET_CURRENT_ENTRENAMIENTO: "SET_CURRENT_ENTRENAMIENTO",
  SET_CURRENT_ALUMNO: "SET_CURRENT_ALUMNO",
  SET_EVALUACION: "SET_EVALUACION",
  SET_GRAFICAS: "SET_GRAFICAS",
    
  FETCH_INSCRIPCIONES_BY_ENTRENAMIENTO: "FETCH_INSCRIPCIONES_BY_ENTRENAMIENTO",
  FETCH_EVALUACION_ALUMNO: "FETCH_EVALUACION_ALUMNO",
  CREATE_EVALUACION_ALUMNO: "CREATE_EVALUACION_ALUMNO",
  UPDATE_EVALUACION_ALUMNO: "UPDATE_EVALUACION_ALUMNO",

  //PROFILE_LOGROS
  INITIALIZE_LOGROS: 'INITIALIZE_LOGROS',
}